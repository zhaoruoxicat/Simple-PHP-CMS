<?php
// /includes/index_faq.php
// 无论从首页还是单独 faq.php 引用，都保证 core.php 已加载
...
try {
    ...
    // 如果表不存在或 SQL 报错，这里可以临时调试输出：
    // echo '<pre>FAQ SQL Error: ' . htmlspecialchars($e->getMessage()) . '</pre>';
    $faqs = [];
}
?>
          ...
          <?php if (empty($faqs)): ?>
            ...
            <div class="faq-item faq-active" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="faq-content">
                <p>You can add FAQ items in database table <code>faq</code> (is_active = 1).</p>
              </div>
